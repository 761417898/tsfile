...
bool TimeBetween::satisfy(int64_t time, Object value) {
...
bool TimeIn::satisfy(int64_t time, Object value) {
...
bool TimeEq::satisfy(int64_t time, Object value) { return value_ == time; }
...
bool TimeNotEq::satisfy(int64_t time, Object value) { return !(value_ == time); }
...
bool TimeGt::satisfy(int64_t time, Object value) { return value_ < time; }
...
bool TimeGtEq::satisfy(int64_t time, Object value) { return value_ <= time; }
...
bool TimeLt::satisfy(int64_t time, Object value) { return value_ > time; }
...
bool TimeLtEq::satisfy(int64_t time, Object value) { return value_ >= time; }
